...
void main(void) {
    ...
    TACCR0  = 1600;             // period = 1ms
    TACTL   = TASSEL_2 + MC_1;   // source SMCLK, up mode

//    LAB 4 CONFIGURATION SPI
//    P3SEL |= 0x0A;
...
//            expectedV = (TBCCR1*3600L)/TBCCR0;
            UART_printf("%d\n\r ", abs(value)); //  %d int, %ld long, %c char, %x hex form, %.3f float 3 decimal place, %s null terminated character array
