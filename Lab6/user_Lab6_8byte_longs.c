...
void main(void) {
    ...
    //TB1 + TB2 ACTIVATION TB2 IS BOT_SERVO AND TB1 TOP_SERVO
    P4DIR |= 0x06;
    P4SEL |= 0x06;
    ...
    // Timer B Config
    TBCCR0 = 40000;
    TBCTL   = TBSSEL_2 + MC_1 +ID_3; // source SMCLK, up mode
    TBCCTL1 = OUTMOD_7;
    TBCCTL2 = OUTMOD_7;
//    TBCCR2 = 3100;
//    TBCCR1 = 3000;
...
//        TXData[RXcounter] = RXData[RXcounter];
        ...
        if(RXcounter == 8){
            mylong1 = (((long) RXData[3])<<24) + (((long) RXData[2])<<16) + (((long) RXData[1]) << 8) + ((long) RXData[0]);
            mylong2 = (((long) RXData[7])<<24) + (((long) RXData[6])<<16) + (((long) RXData[5]) << 8) + ((long) RXData[4]);
            TBCCR1 = mylong1;
            TBCCR2 = mylong2;

            TXData[0] = (unsigned char) mylong1;
            TXData[1] = (unsigned char) (mylong1 >> 8);
            TXData[2] = (unsigned char) (mylong1 >> 16);
            TXData[3] = (unsigned char) (mylong1 >> 24);

            TXData[4] = (unsigned char) mylong2;
            TXData[5] = (unsigned char) (mylong2 >> 8);
            TXData[6] = (unsigned char) (mylong2 >> 16);
            TXData[7] = (unsigned char) (mylong2 >> 24);
